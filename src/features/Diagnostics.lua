...
local CAPABILITIES = {
    ...
    { "getproperties", "Full property discovery for AI dumps" },
    { "gethiddenproperties", "Hidden property discovery" },
    { "saveinstance", "Place/model serialization" },
    { "makefolder", "KryptDbg workspace creation" },
    { "writefile", "Local source export" },
    { "appendfile", "Streaming AI debug dumps" },
